              ...
              <TooltipProvider>
                ...
                <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
                  <Routes>
                    ...
                    <Route path="/admin/assinatura" element={<ProtectedRoute><AdminBillingPage /></ProtectedRoute>} />

                    {/* Routes inside the admin panel */}
                    <Route path="/admin" element={<SubscriptionGuard><AdminLayout /></SubscriptionGuard>}>
